...
export const BLOCK_DEFS: BlockDef[] = [
  ...
  { type: "code", label: "Code block", group: "content", h: 38 },
  { type: "chips", label: "Chips / tags", group: "content", h: 16 },
  { type: "timeline", label: "Timeline", group: "content", h: 42 },
  ...
  { type: "sidebar-split", label: "Sidebar split", group: "layout", h: 48 },
